...
/deep-review 32                  # multi-agent review of the published PR
                                 # prints the run directory and the verdict.json
                                 # path inside it, e.g. /tmp/deep-review-32.Ab12Cd/verdict.json

/address-review 32 --from /tmp/deep-review-32.Ab12Cd/verdict.json
                                 # use the path deep-review printed, not a guessed
                                 # one — those findings plus every thread on the PR:
