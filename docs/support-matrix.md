...
Warnings are quoted in the [Warning reference](#warning-reference) at the end, keyed [W1](#w1) to [W80](#w80). Each number is an anchor: `#w12` jumps to [W12](#w12).
