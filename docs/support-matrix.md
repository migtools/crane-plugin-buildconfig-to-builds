...
Warnings are quoted in the [Warning reference](#warning-reference) at the end, keyed [W1](#w1) to [W72](#w72). Each number is an anchor: `#w12` jumps to [W12](#w12).
...
| `buildconfig-to-shipwright/buildrun-template` | Build | `spec.resources` is set, or the BuildRun has an account to run as: one the BuildConfig named, or one the plugin generated |
