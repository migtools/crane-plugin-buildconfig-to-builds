...
reach the commands the W8, W72, W73, W76 and W78 warnings tell the operator to paste into a
shell, so a change there can put shell text into the `conversion-warnings` annotation.
